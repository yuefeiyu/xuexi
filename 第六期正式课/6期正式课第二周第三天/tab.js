...
var oTab=document.getElementById('tab');
    ...
    var tCells=tHead.rows[0].cells;//获取表头第一行下所有的列(要对元素单个操作）
    var tBody=oTab.tBodies[0];//获取第一个tBody
    var aRows=tBody.rows;//获取tBody下所有的行（表身每一行都整体操作）
    var data=null;
    //1.获取并解析数据
    getDate();
    function getDate(){
